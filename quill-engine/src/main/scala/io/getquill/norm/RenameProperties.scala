 ...
 * iterations of this phase relied on schema propagation via stateful transforms holding
 ...
 * <li> Once these future-renames are staged to Quats through the AST, a simple stateless reduction will then apply
