 ...
 * representing the returning seccovtion with any other operations etc... that they might contain.
 */
object ExpandReturning {

  def applyMap(returning: ReturningAction)(f: (Ast, Statement) => String)(idiom: Idiom, naming: NamingStrategy, idiomContext: IdiomContext) = {
  ...
  def apply(returning: ReturningAction, renameAlias: Option[String] = None)(idiom: Idiom, naming: NamingStrategy, idiomContext: IdiomContext): List[(Ast, Statement)] = {
