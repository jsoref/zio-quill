 ...
 * in the case where we are substituting a real type for a Quat.Null or Quat.Generic (roughly speaking, a 'Bottom Type').
 ...
 * variables are being beta-reduced irregardless of subtyping.
 */
